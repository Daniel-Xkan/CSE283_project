# task 2: recurrence vs no recurrence
...
fig_save_path = os.path.join(dir, "cls2_output", "figs")
table_save_path = os.path.join(dir, "cls2_output", "table")


def read_recurrence_info():
    """read tpm matrix and labels"""
    current_dir = os.getcwd()
    dir = os.path.dirname(current_dir)
    dst = os.path.join(dir, "data", "postfilter_data", "recurrence", "tpm_filtered_ranked.txt")
...
def read_label():
    current_dir = os.getcwd()
    dir = os.path.dirname(current_dir)
    dst = os.path.join(dir, "data", "postfilter_data", "recurrence", "sample_recurStatus.txt")
...
if __name__ == '__main__':
    ...
    candiK = [10, 15, 25, 40, 60, 100, 150, 200, 250]
    all_res = {}
    for k in candiK:
